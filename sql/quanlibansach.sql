...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 26, 2022 lúc 05:06 PM
...
--
-- Cấu trúc bảng cho bảng `t_chi_tiet_don_hang`
--

CREATE TABLE `t_chi_tiet_don_hang` (
  `t_chi_tiet_don_hang_id` int(10) NOT NULL,
  `don_hang_id` int(10) NOT NULL,
  `san_pham_id` int(10) NOT NULL,
  `ten_san_pham` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `anh_san_pham` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `so_luong` int(10) NOT NULL,
  `gia_ban` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `t_don_hang`
--

CREATE TABLE `t_don_hang` (
  `t_don_hang_id` int(10) NOT NULL,
  ...
  `ngay_mua` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `tong_tien_don_hang` int(20) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `t_gio_hang`
--

CREATE TABLE `t_gio_hang` (
  `t_gio_hang_id` int(10) NOT NULL,
  `khach_hang_id` int(10) NOT NULL,
  `san_pham_id` int(10) NOT NULL,
  `ten_san_pham` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `anh_san_pham` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `so_luong` int(10) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `t_nguoi_dung`
--

CREATE TABLE `t_nguoi_dung` (
  `t_nguoi_dung_id` int(6) NOT NULL,
  `ten_day_du` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `kieu_nguoi_dung` varchar(20) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `t_nguoi_dung`
--

INSERT INTO `t_nguoi_dung` (`t_nguoi_dung_id`, `ten_day_du`, `dia_chi`, `so_dien_thoai`, `gioi_tinh`, `email`, `mat_khau`, `kieu_nguoi_dung`) VALUES
(0, 'dat', '123', '1231231231', 'Khác', 'dat@gmail.com', '123123', 'nguoidung');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `t_san_pham`
--

CREATE TABLE `t_san_pham` (
...
--
-- Đang đổ dữ liệu cho bảng `t_san_pham`
--

INSERT INTO `t_san_pham` (`t_san_pham_id`, `ten_san_pham`, `gia_san_pham`, `anh_san_pham`, `tac_gia`, `the_loai`, `chi_tiet_san_pham`) VALUES
...
--
-- Cấu trúc bảng cho bảng `t_tac_gia`
--

CREATE TABLE `t_tac_gia` (
  `t_tac_gia_id` int(11) NOT NULL,
...
--
-- Cấu trúc bảng cho bảng `t_the_loai_sach`
--

CREATE TABLE `t_the_loai_sach` (
  `t_the_loai_sach_id` int(11) NOT NULL,
  `the_loai` varchar(20) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Chỉ mục cho bảng `t_chi_tiet_don_hang`
--
ALTER TABLE `t_chi_tiet_don_hang`
  ADD PRIMARY KEY (`t_chi_tiet_don_hang_id`);

--
-- Chỉ mục cho bảng `t_gio_hang`
--
ALTER TABLE `t_gio_hang`
  ADD PRIMARY KEY (`t_gio_hang_id`);

--
-- Chỉ mục cho bảng `t_san_pham`
--
ALTER TABLE `t_san_pham`
  ADD PRIMARY KEY (`t_san_pham_id`);

--
-- Chỉ mục cho bảng `t_tac_gia`
--
ALTER TABLE `t_tac_gia`
  ADD PRIMARY KEY (`t_tac_gia_id`);

--
-- Chỉ mục cho bảng `t_the_loai_sach`
--
ALTER TABLE `t_the_loai_sach`
  ADD PRIMARY KEY (`t_the_loai_sach_id`);
...
--
-- AUTO_INCREMENT cho bảng `t_chi_tiet_don_hang`
--
ALTER TABLE `t_chi_tiet_don_hang`
  MODIFY `t_chi_tiet_don_hang_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `t_gio_hang`
--
ALTER TABLE `t_gio_hang`
  MODIFY `t_gio_hang_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `t_san_pham`
--
ALTER TABLE `t_san_pham`
  MODIFY `t_san_pham_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT cho bảng `t_tac_gia`
--
ALTER TABLE `t_tac_gia`
  MODIFY `t_tac_gia_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `t_the_loai_sach`
--
ALTER TABLE `t_the_loai_sach`
  MODIFY `t_the_loai_sach_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
